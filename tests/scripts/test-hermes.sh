...
SCRIPT="$REPO/../skills/cloud-weaver-waha/scripts/deploy-hermes.py"
COMPOSE="$REPO/../skills/cloud-weaver-waha/scripts/compose/compose.yaml"
INITDB="$REPO/../skills/cloud-weaver-waha/scripts/initdb.sql"
